...
const licenses = [
  ...
  "MIT License",
  "BSD 2-Clause 'simiplfied' License",
...
const questions = [
  ...
  },
  {
    ...
    name: "contibuting",
    message:
      "Please provide your own guidelines for contributing to this (or leave blank if you would like none). The default, 'Contributor Covenant Code of Conduct', will insert that covenant (see here: https://www.contributor-covenant.org/version/2/1/code_of_conduct/code_of_conduct.txt). Any headings should begin with three Number Signs and a space after them (sub headings should add a Number sign).",
